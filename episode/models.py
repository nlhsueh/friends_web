...
class Season(models.Model):
    ...
    description = models.CharField(max_length=1500) # 該季主要劇情描述
...
class Episode(models.Model):
    ...
    eng_plot = models.CharField(null=True, max_length=1500) # 該集英文描述
    tw_plot = models.CharField(null=True, max_length=1500) # 該集中文描述
